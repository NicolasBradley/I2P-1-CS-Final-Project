...
typedef struct Map_{
 ...
 //   int maplevel;
    ...
    int coin_disappearing[MAX_MAP_ROW][MAX_MAP_COL];
    ...
    ALLEGRO_SAMPLE* drink_audio;
//    HEART_STATUS heart_status[MAX_MAP_ROW][MAX_MAP_COL];
//    int HEART_disappearing[MAX_MAP_ROW][MAX_MAP_COL];
